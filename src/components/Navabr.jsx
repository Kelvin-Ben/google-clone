...
const Navabr = ({ darkTheme, setDarkTheme}) => {
  return (
    <div className='p-5 pb-0 flex flex-wrap sm:justfiy-between justify-center border-b dark:border-gray-700 border-gray-200'>
